...
const About = () => {
  ...
  return (
    <>
      <section
        className="max-container padding-container mb-5 flex flex-col gap-20 py-10 bg-slate-100 rounded pb-32 mt-5 md:gap-28 lg:py-20 xl:flex-row shadow w-[95%]"
        style={sectionStyle}
      >
        <div>
          <h2 className="mb-5 text-black font-bold text-3xl ">About Us</h2>
          <div className="column gap-10 md:flex lg:flex xl:flex">
            ...
            />
            <div><br />
              <h3 className="text-xl text-black font-bold underline">Get to Know Us</h3><br />
              <p>
